...
exports.main = async (event, context) => {
  try {
    ...
    console.log(openid);
    if (openid === 'oFow_47L28qyrmMhI5SxLFONj4Wg') {//_openidA放到单引号里
        openid = 'oFow_46dAUB9fY5KMkBMAXUGD0lY';//_openidB放到单引号
    } else {
        openid = 'oFow_47L28qyrmMhI5SxLFONj4Wg';//_openidA放到单引号里
    }
